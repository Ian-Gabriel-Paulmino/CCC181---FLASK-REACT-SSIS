...
-- SELECT S.Student_Id,S.FirstName,S.LastName,S.Year_Level,S.Gender,S.Program_Code,S.Profile_Url,C.College_Code,C.College_Name 
-- FROM Students S LEFT JOIN Programs P ON S.Program_Code = P.Program_Code 
